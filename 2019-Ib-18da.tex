...
(D1)--(D)
(C1)--(D)circle (0.25pt)node[left=-2pt]{$D$}
(D)--(C)
(A)--(D)
(M)--(N)
(A1)--(D)
...
\fill[blue!40!white,opacity=0.6](M)--(N)--(D)--(E)--cycle;
\fill[pink!40!white,opacity=0.6](D)--(C1)--(E)--cycle;
...
(C1)--(E)circle (0.25pt)node[right=-2pt]{$E$}
(A1)--(M)circle (0.25pt)node[right=-2pt]{$M$}
(N)circle (0.25pt)node[left=-2pt]{$N$}
;
%% ===========================================
\draw[thin,dash pattern=on 2pt off 2pt](A1)--(A)
(D1)--(D)
